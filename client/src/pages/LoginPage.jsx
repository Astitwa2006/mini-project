  ...
  return (
    <div className="min-h-screen box-border bg-bg text-text flex flex-col items-center justify-center font-sans p-6">
      <div className="w-full max-w-[420px] flex flex-col">
        ...
        {/* Auth Form - ONLY GOOGLE */}
        <div className="mt-10 flex flex-col gap-3">
          <button 
            onClick={handleGoogleLogin}
            disabled={loading}
            className="w-full h-[54px] rounded-xl border border-border-heavy bg-surface-base flex items-center justify-center gap-3 font-semibold text-[17px] hover:bg-surface-alt transition-colors shadow-sm"
          >
